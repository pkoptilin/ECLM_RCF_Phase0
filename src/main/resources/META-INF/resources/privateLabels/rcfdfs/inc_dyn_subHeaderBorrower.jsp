...
<script language="JavaScript" type="text/javascript">
    ...
    <script language="JavaScript" type="text/javascript" src="privateLabels/rcfdfs/new_ui/main.js"></script>
    <link rel="stylesheet" type="text/css" href="privateLabels/rcfdfs/new_ui/main.css" />
