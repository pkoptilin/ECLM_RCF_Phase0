...
/**
 * QDCpdetails is a Querydsl query type for QDCpdetails
 */
@Generated("com.mysema.query.sql.codegen.MetaDataSerializer")
public class QDCpdetails extends com.mysema.query.sql.RelationalPathBase<QDCpdetails> {

    private static final long serialVersionUID = 1538621058;

    public static final QDCpdetails dCpdetails = new QDCpdetails("D_CPDETAILS");
    ...
    public final StringPath cpnamepcpnamelist = createString("cpnamepcpnamelist");
...
//    public final StringPath name = createString("name");
    ...
    public final com.mysema.query.sql.PrimaryKey<QDCpdetails> dCpdetails11Pk = createPrimaryKey(sysId);

    public final com.mysema.query.sql.ForeignKey<QSDictValue> dCpdetails11AddlvendorsFk = createForeignKey(addlvendors, "ID");

    public final com.mysema.query.sql.ForeignKey<QSDictValue> dCpdetails11TermwocauseFk = createForeignKey(termwocause, "ID");

    public final com.mysema.query.sql.ForeignKey<QSDictMultiValue> dCpdetails11AgrcatFk = createForeignKey(agrcat, "ID");

    public final com.mysema.query.sql.ForeignKey<QSDictValue> dCpdetails11AutorenewalFk = createForeignKey(autorenewal, "ID");

    public final com.mysema.query.sql.ForeignKey<QSDictValue> dCpdetail11ContractstatusFk = createForeignKey(contractstatus, "ID");

    public final com.mysema.query.sql.ForeignKey<QSDictValue> dCpdetails11Thirdparty1Fk = createForeignKey(thirdparty1, "ID");

    public final com.mysema.query.sql.ForeignKey<QSPoContact> dCpdetails11RequestorFk = createForeignKey(requestor, "ID");

    public final com.mysema.query.sql.ForeignKey<QSDictValue> dCpdetails11AgrtypeFk = createForeignKey(agrtype, "ID");

    public final com.mysema.query.sql.ForeignKey<QSGroups> dCpdetails11BussunitFk = createForeignKey(bussunit, "GROUP_ID");

    public final com.mysema.query.sql.ForeignKey<QSDictValue> dCpdetails11GovlawFk = createForeignKey(govlaw, "ID");

    public final com.mysema.query.sql.ForeignKey<QSBobjectMultiValue> dCpdetail11ChangedclausesFk = createForeignKey(changedclauses, "ID");

    public final com.mysema.query.sql.ForeignKey<QSBobjectMultiValue> dCpdetail11RemovedclausesFk = createForeignKey(removedclauses, "ID");

    public final com.mysema.query.sql.ForeignKey<QSBobjectMultiValue> dCpdetails11EvclausesFk = createForeignKey(evclauses, "ID");

    public final com.mysema.query.sql.ForeignKey<QSDictValue> dCpdetails11EntityFk = createForeignKey(entity, "ID");

    public final com.mysema.query.sql.ForeignKey<QSDictValue> dCpdetails11TermtypeFk = createForeignKey(termtype, "ID");

    public final com.mysema.query.sql.ForeignKey<QSBobject> dCpdetails11CpnameFk = createForeignKey(cpname, "ID");

    public final com.mysema.query.sql.ForeignKey<QSBobjectMultiValue> dCpdetails11UsedclausesFk = createForeignKey(usedclauses, "ID");

    public final com.mysema.query.sql.ForeignKey<QSDictValue> dCpdetails11IntcollreqFk = createForeignKey(intcollreq, "ID");

    public final com.mysema.query.sql.ForeignKey<QSBobject> dCpdetails11SysIdFk = createForeignKey(sysId, "ID");

    public final com.mysema.query.sql.ForeignKey<QSBobjectMultiValue> dCpdetails11AddedclausesFk = createForeignKey(addedclauses, "ID");

    public final com.mysema.query.sql.ForeignKey<QSDictValue> dCpdetails11EntitytypeFk = createForeignKey(entitytype, "ID");

    public QDCpdetails(String variable) {
        super(QDCpdetails.class, forVariable(variable), "VZAKHARCHENKO", "D_CPDETAILS");
        addMetadata();
    }

    public QDCpdetails(String variable, String schema, String table) {
        super(QDCpdetails.class, forVariable(variable), schema, table);
        addMetadata();
    }

    public QDCpdetails(Path<? extends QDCpdetails> path) {
        super(path.getType(), path.getMetadata(), "VZAKHARCHENKO", "D_CPDETAILS");
        addMetadata();
    }

    public QDCpdetails(PathMetadata<?> metadata) {
        super(QDCpdetails.class, metadata, "VZAKHARCHENKO", "D_CPDETAILS");
        addMetadata();
    }
    ...
    public void addMetadata() {
        ...
        addMetadata(cpnamepcpnamelist, ColumnMetadata.named("CPNAMEPCPNAMELIST").withIndex(16).ofType(Types.VARCHAR).withSize(64).notNull());
