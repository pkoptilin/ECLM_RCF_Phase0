...
/**
 * QDCsservices is a Querydsl query type for QDCsservices
 */
@Generated("com.mysema.query.sql.codegen.MetaDataSerializer")
public class QDCsservices extends com.mysema.query.sql.RelationalPathBase<QDCsservices> {

    private static final long serialVersionUID = -340305631;

    public static final QDCsservices dCsservices = new QDCsservices("D_CSSERVICES");
    ...
    public final com.mysema.query.sql.PrimaryKey<QDCsservices> dCsservices12Pk = createPrimaryKey(sysId);

//    public final com.mysema.query.sql.ForeignKey<QSBobject> dCsservices12SysParentidFk = createForeignKey(sysParentid, "ID");

    public final com.mysema.query.sql.ForeignKey<QSDictValue> dCsservic12SerunitmeasureFk = createForeignKey(serunitmeasure, "ID");

    public final com.mysema.query.sql.ForeignKey<QSBobject> dCsservice12SysBobjectidFk = createForeignKey(sysBobjectid, "ID");

    public QDCsservices(String variable) {
        super(QDCsservices.class, forVariable(variable), "VZAKHARCHENKO", "D_CSSERVICES");
        addMetadata();
    }

    public QDCsservices(String variable, String schema, String table) {
        super(QDCsservices.class, forVariable(variable), schema, table);
        addMetadata();
    }

    public QDCsservices(Path<? extends QDCsservices> path) {
        super(path.getType(), path.getMetadata(), "VZAKHARCHENKO", "D_CSSERVICES");
        addMetadata();
    }

    public QDCsservices(PathMetadata<?> metadata) {
        super(QDCsservices.class, metadata, "VZAKHARCHENKO", "D_CSSERVICES");
        addMetadata();
    }
