...
/**
 * QDCfr1contacts is a Querydsl query type for QDCfr1contacts
 */
@Generated("com.mysema.query.sql.codegen.MetaDataSerializer")
public class QDCfr1contacts extends com.mysema.query.sql.RelationalPathBase<QDCfr1contacts> {

    private static final long serialVersionUID = -1166995576;

    public static final QDCfr1contacts dCfr1contacts = new QDCfr1contacts("D_CFR1CONTACTS");
    ...
    public final com.mysema.query.sql.PrimaryKey<QDCfr1contacts> dCfr1contacts14Pk = createPrimaryKey(sysId);

    public final com.mysema.query.sql.ForeignKey<QSBobject> dCfr1conta14SysBobjectidFk = createForeignKey(sysBobjectid, "ID");

//    public final com.mysema.query.sql.ForeignKey<QSBobject> dCfr1contac14SysParentidFk = createForeignKey(sysParentid, "ID");

    public QDCfr1contacts(String variable) {
        super(QDCfr1contacts.class, forVariable(variable), "VZAKHARCHENKO", "D_CFR1CONTACTS");
        addMetadata();
    }

    public QDCfr1contacts(String variable, String schema, String table) {
        super(QDCfr1contacts.class, forVariable(variable), schema, table);
        addMetadata();
    }

    public QDCfr1contacts(Path<? extends QDCfr1contacts> path) {
        super(path.getType(), path.getMetadata(), "VZAKHARCHENKO", "D_CFR1CONTACTS");
        addMetadata();
    }

    public QDCfr1contacts(PathMetadata<?> metadata) {
        super(QDCfr1contacts.class, metadata, "VZAKHARCHENKO", "D_CFR1CONTACTS");
        addMetadata();
    }
