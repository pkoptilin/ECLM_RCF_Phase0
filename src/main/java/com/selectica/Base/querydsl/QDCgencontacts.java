...
/**
 * QDCgencontacts is a Querydsl query type for QDCgencontacts
 */
@Generated("com.mysema.query.sql.codegen.MetaDataSerializer")
public class QDCgencontacts extends com.mysema.query.sql.RelationalPathBase<QDCgencontacts> {

    private static final long serialVersionUID = 1005156083;

    public static final QDCgencontacts dCgencontacts = new QDCgencontacts("D_CGENCONTACTS");
    ...
    public final com.mysema.query.sql.PrimaryKey<QDCgencontacts> dCgencontacts14Pk = createPrimaryKey(sysId);

    public final com.mysema.query.sql.ForeignKey<QSBobject> dCgenconta14SysBobjectidFk = createForeignKey(sysBobjectid, "ID");

//    public final com.mysema.query.sql.ForeignKey<QSBobject> dCgencontac14SysParentidFk = createForeignKey(sysParentid, "ID");

    public QDCgencontacts(String variable) {
        super(QDCgencontacts.class, forVariable(variable), "VZAKHARCHENKO", "D_CGENCONTACTS");
        addMetadata();
    }

    public QDCgencontacts(String variable, String schema, String table) {
        super(QDCgencontacts.class, forVariable(variable), schema, table);
        addMetadata();
    }

    public QDCgencontacts(Path<? extends QDCgencontacts> path) {
        super(path.getType(), path.getMetadata(), "VZAKHARCHENKO", "D_CGENCONTACTS");
        addMetadata();
    }

    public QDCgencontacts(PathMetadata<?> metadata) {
        super(QDCgencontacts.class, metadata, "VZAKHARCHENKO", "D_CGENCONTACTS");
        addMetadata();
    }
