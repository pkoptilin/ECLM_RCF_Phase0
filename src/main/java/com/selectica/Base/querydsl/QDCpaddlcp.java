...
/**
 * QDCpaddlcp is a Querydsl query type for QDCpaddlcp
 */
@Generated("com.mysema.query.sql.codegen.MetaDataSerializer")
public class QDCpaddlcp extends com.mysema.query.sql.RelationalPathBase<QDCpaddlcp> {

    private static final long serialVersionUID = -730380968;

    public static final QDCpaddlcp dCpaddlcp = new QDCpaddlcp("D_CPADDLCP");
    ...
    public final com.mysema.query.sql.PrimaryKey<QDCpaddlcp> dCpaddlcp10Pk = createPrimaryKey(sysId);

    public final com.mysema.query.sql.ForeignKey<QSDictValue> dCpaddlcp10AcpctryFk = createForeignKey(acpctry, "ID");

    public final com.mysema.query.sql.ForeignKey<QSDictValue> dCpaddlcp10AcpstateFk = createForeignKey(acpstate, "ID");

    public final com.mysema.query.sql.ForeignKey<QSDictValue> dCpaddlcp10AcpentitytypeFk = createForeignKey(acpentitytype, "ID");

//    public final com.mysema.query.sql.ForeignKey<QSBobject> dCpaddlcp10SysParentidFk = createForeignKey(sysParentid, "ID");

    public final com.mysema.query.sql.ForeignKey<QSBobject> dCpaddlcp10SysBobjectidFk = createForeignKey(sysBobjectid, "ID");

    public QDCpaddlcp(String variable) {
        super(QDCpaddlcp.class, forVariable(variable), "VZAKHARCHENKO", "D_CPADDLCP");
        addMetadata();
    }

    public QDCpaddlcp(String variable, String schema, String table) {
        super(QDCpaddlcp.class, forVariable(variable), schema, table);
        addMetadata();
    }

    public QDCpaddlcp(Path<? extends QDCpaddlcp> path) {
        super(path.getType(), path.getMetadata(), "VZAKHARCHENKO", "D_CPADDLCP");
        addMetadata();
    }

    public QDCpaddlcp(PathMetadata<?> metadata) {
        super(QDCpaddlcp.class, metadata, "VZAKHARCHENKO", "D_CPADDLCP");
        addMetadata();
    }
