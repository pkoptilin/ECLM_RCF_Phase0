...
/**
 * QDCpaddresses is a Querydsl query type for QDCpaddresses
 */
@Generated("com.mysema.query.sql.codegen.MetaDataSerializer")
public class QDCpaddresses extends com.mysema.query.sql.RelationalPathBase<QDCpaddresses> {

    private static final long serialVersionUID = -301271070;

    public static final QDCpaddresses dCpaddresses = new QDCpaddresses("D_CPADDRESSES");
    ...
    public final com.mysema.query.sql.PrimaryKey<QDCpaddresses> dCpaddresses13Pk = createPrimaryKey(sysId);

    public final com.mysema.query.sql.ForeignKey<QSBobject> dCpaddress13SysBobjectidFk = createForeignKey(sysBobjectid, "ID");

    public final com.mysema.query.sql.ForeignKey<QSDictValue> dCpaddresses13CadrstateFk = createForeignKey(cadrstate, "ID");

    public final com.mysema.query.sql.ForeignKey<QSDictValue> dCpaddresses13CadrctryFk = createForeignKey(cadrctry, "ID");

    public final com.mysema.query.sql.ForeignKey<QSDictValue> dCpaddresses13CadrtypeFk = createForeignKey(cadrtype, "ID");

//    public final com.mysema.query.sql.ForeignKey<QSBobject> dCpaddresse13SysParentidFk = createForeignKey(sysParentid, "ID");

    public QDCpaddresses(String variable) {
        super(QDCpaddresses.class, forVariable(variable), "VZAKHARCHENKO", "D_CPADDRESSES");
        addMetadata();
    }

    public QDCpaddresses(String variable, String schema, String table) {
        super(QDCpaddresses.class, forVariable(variable), schema, table);
        addMetadata();
    }

    public QDCpaddresses(Path<? extends QDCpaddresses> path) {
        super(path.getType(), path.getMetadata(), "VZAKHARCHENKO", "D_CPADDRESSES");
        addMetadata();
    }

    public QDCpaddresses(PathMetadata<?> metadata) {
        super(QDCpaddresses.class, metadata, "VZAKHARCHENKO", "D_CPADDRESSES");
        addMetadata();
    }
