...
/**
 * QDCsproducts is a Querydsl query type for QDCsproducts
 */
@Generated("com.mysema.query.sql.codegen.MetaDataSerializer")
public class QDCsproducts extends com.mysema.query.sql.RelationalPathBase<QDCsproducts> {

    private static final long serialVersionUID = 1571691047;

    public static final QDCsproducts dCsproducts = new QDCsproducts("D_CSPRODUCTS");
    ...
    public final com.mysema.query.sql.PrimaryKey<QDCsproducts> dCsproducts12Pk = createPrimaryKey(sysId);

//    public final com.mysema.query.sql.ForeignKey<QSBobject> dCsproducts12SysParentidFk = createForeignKey(sysParentid, "ID");

    public final com.mysema.query.sql.ForeignKey<QSBobject> dCsproduct12SysBobjectidFk = createForeignKey(sysBobjectid, "ID");

    public final com.mysema.query.sql.ForeignKey<QSDictValue> dCsproduc12PrdunitmeasureFk = createForeignKey(prdunitmeasure, "ID");

    public QDCsproducts(String variable) {
        super(QDCsproducts.class, forVariable(variable), "VZAKHARCHENKO", "D_CSPRODUCTS");
        addMetadata();
    }

    public QDCsproducts(String variable, String schema, String table) {
        super(QDCsproducts.class, forVariable(variable), schema, table);
        addMetadata();
    }

    public QDCsproducts(Path<? extends QDCsproducts> path) {
        super(path.getType(), path.getMetadata(), "VZAKHARCHENKO", "D_CSPRODUCTS");
        addMetadata();
    }

    public QDCsproducts(PathMetadata<?> metadata) {
        super(QDCsproducts.class, metadata, "VZAKHARCHENKO", "D_CSPRODUCTS");
        addMetadata();
    }
