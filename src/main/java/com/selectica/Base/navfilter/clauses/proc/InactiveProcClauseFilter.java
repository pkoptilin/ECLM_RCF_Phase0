package com.selectica.Base.navfilter.clauses.proc;
 ...
 */
public class InactiveProcClauseFilter extends StaticSQLQueryMCPExpression {
    /*
                                <![CDATA[
    ...
    public List<QModelType> evaluateExpression(FQNodeEvaluator ec) throws BaseException {
        ...
        QModelType modelType = RCFSQLHelper.buildDictionaryQModelType(QDClauseattributes.dClauseattributes, QDClauseattributes.dClauseattributes.sysId,
                new DictionaryFilterParam(QDClauseattributes.dClauseattributes.contracttyperef, "CProcBO"),
                new DictionaryFilterParam(QDClauseattributes.dClauseattributes.clausestatus, "inactive")
        );
