 ...
 */
public class ExpiringThisQuarterContractsFilter extends StaticSQLQueryMCPExpression {
    ...
    public List<QModelType> evaluateExpression(FQNodeEvaluator ec) throws BaseException {
        ...
        DateTime tomorrowStart = todayStart.plusMonths(3).withDayOfMonth(1).withTimeAtStartOfDay();
