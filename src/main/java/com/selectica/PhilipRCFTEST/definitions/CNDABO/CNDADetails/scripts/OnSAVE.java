package com.selectica.PhilipRCFTEST.definitions.CNDABO.CNDADetails.scripts;

import com.selectica.PhilipRCFTEST.eclm.definitions.CNDABO.CNDADetails.scripts.OnSaveTrigger;
