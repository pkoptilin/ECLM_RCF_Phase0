...
import com.selectica.PhilipRCFTEST.eclm.definitions.ReminderStatus;
    ...
    public Boolean process() throws Exception {
        ...
        if (endDate != null) {
            if ("yes".equals(info.getAutoRenewal())) {
                ...
                reminder.setComments("Your contract " + info.getContractName() + " will be automatically renewed at " + endDate);
