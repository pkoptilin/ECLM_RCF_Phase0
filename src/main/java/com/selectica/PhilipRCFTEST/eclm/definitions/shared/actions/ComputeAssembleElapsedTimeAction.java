package com.selectica.PhilipRCFTEST.eclm.definitions.shared.actions;
 ...
 */
public class ComputeAssembleElapsedTimeAction extends AbstractBOWriteScript<Boolean> {
    /*
                <![CDATA[
					var bp = thisComponent.getBundleProxy();
					var elapsedTime= bp.getParameterValueObjectFromAnyComponent("ReqContractStats","elapsedAssembleTime");
					var elapsedContractCycleTime = bp.getParameterValueObjectFromAnyComponent("ReqContractStats","elapsedContractCycleTime");
					var startTime = bp.getParameterValueObjectFromAnyComponent("ReqContractStats","lastAssembleStartTime");
					...
					thisComponent.setValue("CProcData/ReqContractStats/elapsedAssembleTime",totalTime);
    ...
    public Boolean process() throws Exception {
        ...
        Double elapsedTime = contractStats.getElapsedAssembleTime();
        if (elapsedTime == null) {
            elapsedTime = 0d;
        }
        ...
        contractStats.setElapsedAssembleTime(totalReqTime);
