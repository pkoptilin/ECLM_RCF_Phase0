 ...
 */
public class SetIntSigner extends AbstractDataWriteScript<String> {
    /*
            <![CDATA[
            result = "";
            ...
            if (useEsign != null && ndaIsStandardContract != null &&
                ...
                result = root.getValue("user").getUserWrapper().getUserName();
            }
            ]]>
     */
    @Override
    public String process() throws Exception {
        ...
        if (useEsign && isStandardContract) {
            ...
            if (cpName != null && !cpName.isEmpty()) {
                ...
                return userWrapper.getFirstLastName();
            }
