package com.selectica.PhilipRCFTEST.eclm.definitions.DCustomerBO.DCustDBA.scripts;

import com.selectica.PhilipRCFTEST.stubs.DCustDBA;
...
public class OnSaveTrigger extends AbstractDataWriteScript<Boolean> {
    ...
    public Boolean process() throws Exception {
        DCustDetails details = getHelper().getInfoComponentStub();
