package com.selectica.PhilipRCFTEST.eclm.definitions.RREPBO.RRepDetails.actions;
...
/**
 * Created by vshilkin on 11.03.2015.
 */
public class OnTimeTrigger extends AbstractBOWriteScript<Boolean> {
    ...
    private void sendEndContractNotification() throws Exception {
        ...
        RRepDetails info = getHelper().getInfoComponentStub();
        DateTime endDate;
