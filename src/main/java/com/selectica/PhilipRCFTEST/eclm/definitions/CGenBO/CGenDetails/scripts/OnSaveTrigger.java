package com.selectica.PhilipRCFTEST.eclm.definitions.CGenBO.CGenDetails.scripts;
...
public class OnSaveTrigger extends AbstractDataWriteScript<Boolean> {
    ...
    public Boolean process() throws Exception {
        CGenDetails info = getHelper().getCurrentComponentStub();
            ...
            if ("TaskAuthAmendWF".equals(event)) {
                ...
                if (parent != null) {
                    ...
                    if (bundleWrapper != null) {
                        CGenDetails parentInfo = getHelper().getInfoComponentStubForBundle(bundleWrapper);
