package com.selectica.PhilipRCFTEST.eclm.definitions.CSalesBO.CSProducts.scripts;

import com.selectica.PhilipRCFTEST.stubs.CSProducts;
...
public class OnChangeTrigger extends AbstractDataWriteScript<Boolean> {
    ...
    public Boolean process() throws Exception {
        CSProducts product = getHelper().getCurrentComponentStub();
