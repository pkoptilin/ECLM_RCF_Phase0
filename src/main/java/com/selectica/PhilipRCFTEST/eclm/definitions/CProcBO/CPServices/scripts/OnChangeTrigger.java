package com.selectica.PhilipRCFTEST.eclm.definitions.CProcBO.CPServices.scripts;


import com.selectica.PhilipRCFTEST.stubs.CPServices;
...
public class OnChangeTrigger extends AbstractDataWriteScript<Boolean> {
    ...
    public Boolean process() throws Exception {
        CPServices service = getHelper().getCurrentComponentStub();
