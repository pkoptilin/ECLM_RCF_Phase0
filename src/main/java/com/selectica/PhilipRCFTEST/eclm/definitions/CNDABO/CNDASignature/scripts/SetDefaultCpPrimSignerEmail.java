package com.selectica.PhilipRCFTEST.eclm.definitions.CNDABO.CNDASignature.scripts;

import com.selectica.PhilipRCFTEST.stubs.Contact;
import com.selectica.PhilipRCFTEST.stubs.ContractInfoComponent;
 ...
 */
public class SetDefaultCpPrimSignerEmail extends AbstractDataWriteScript<String> {
    /*
            <![CDATA[
            result = "";
                ...
                if (cp != "") {
                    ...
                    while (mIt.hasNext()) {
                        ...
                        if (s.equals("Active")) {
                            ...
                            var cpPrimSigner = b.getParameterValueObjectFromAnyComponent("ReqContact", "prContactName");
                            if (cpPrimSigner != null && !cpPrimSigner.toString().isEmpty() && n.equalsIgnoreCase(cp.toString())) {
                                result = cpPrimSigner.toString();
                                break;
                            }
                        }
                    }
        ...
        if (useEsign && isStandardContract) {
            ...
            if (cpName != null && !cpName.isEmpty()) {
                ...
                if (bundleWrapper != null) {
                    ...
                    if(contact != null){
                        return contact.getPrContactEmail();
                    }
                }
            }
